package com.example.utsinfopariwisata;
...
public class TourismPlace implements Serializable {
    private int ImageResourceId;
    private String name;
    private String location;
    private String description;

    public TourismPlace(int ImageResourceId, String name, String location, String description) {
    ...
    public static List<TourismPlace> getSamplePlaces() {
        ...
        samplePlaces.add(new TourismPlace(R.drawable.image6, "Tanah Lot", "Tabanan, Bali", "Tanah Lot is one of Bali's most famous landmarks, known for its picturesque offshore setting and stunning sunset backdrops. Located on a rock formation just off the coast in Tabanan, Bali, this iconic sea temple attracts both local and international visitors who come to admire its beauty and spiritual significance.\n" +
                "\n" +
        ...
        Collections.sort(samplePlaces, new Comparator<TourismPlace>() {
            @Override
            public int compare(TourismPlace place1, TourismPlace place2) {
